...
export class AudioSelectorDialog extends Component {
    static template = "web_elearning_video.AudioDialog";
    static components = {
    ...
    _setupAudioElements() {
        ...
        this.playBtn = $('button.note-audio-play');
        this.downloadBtn = $('button.note-audio-download');
