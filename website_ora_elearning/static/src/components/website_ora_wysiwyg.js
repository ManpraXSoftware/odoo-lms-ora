...
import { BASIC_PLUGINS, FULL_EDIT_PLUGINS } from "@website_forum/plugins/plugin_sets";
import { useResizerOra } from "@website_ora_elearning/components/resizer_hook";
import { Wysiwyg } from "@html_editor/wysiwyg";

export class WebsiteOraWysiwyg extends Wysiwyg {
    static template = "website_ora_elearning.WebsiteOraWysiwyg";
    static props = {
        ...super.props,
    ...
    setup() {
        ...
        if (this.props.resizable) {
            ...
            this.onResizerMouseDownOra = useResizerOra("content");
        }
...
export class WebsiteOraFullscreenWysiwyg extends Wysiwyg {
    static template = "website_ora_elearning.WebsiteOraWysiwyg";
    static props = {
        ...super.props,
        textareaEl: HTMLElement,
